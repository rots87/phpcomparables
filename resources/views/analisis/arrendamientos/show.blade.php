...
<div class="container">
    {!! Form::open(['route' => 'analisis.analisisArrendamientos', 'method' => 'POST']) !!}
    ...
    <div class="row justify-content-between">
        <button type="submit" class="btn btn-success">Analizar Seleccionados</button>
...
<script type="text/javascript">
    function doFilter() {
        ...
        var url = {!!json_encode(route('analisis.showArrendamientos', $anio)) !!};
