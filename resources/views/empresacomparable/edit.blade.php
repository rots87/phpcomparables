...
<div class="container">
    {!! Form::open(array('route' => ['empresacomparable.update',$data->id], 'method' => 'POST')) !!}
    @method('PUT')
    <div class="row justify-content-center form-group">
        <label for="nombre" class="col-sm-2 col-form-label">Nombre</label>
        <div class="col-sm-6">
            <input type="text" value="{{ $data->nombre }}" name="nombre" id="nombre" class="form-control" onkeyup="this.value = this.value.toUpperCase();" required>
        </div>
    </div>
    <div class="row justify-content-center form-group">
        <label for="giro" class="col-sm-2 col-form-label">Giro</label>
        <div class="col-sm-6">
            <input type="text" value="{{ $data->giro }}" name="giro" id="giro"class="form-control" onkeyup="this.value = this.value.toUpperCase();" required>
        </div>
    </div>
    <div class="row justify-content-center form-group">
    ...
    <div class="row justify-content-center form-group">
        ...
        <div class="col-sm-6">
            <input type="text" value="{{ $data->expediente }}" name="expediente" id="expediente" class="form-control" required>
        </div>
    </div>
